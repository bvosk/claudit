...
```
x-anthropic-billing-header: cc_version=2.1.39.c39; cc_entrypoint=sdk-cli; cch=077b0;
```
...
IMPORTANT - Use the correct year in search queries:
  - Today's date is [SCRUBBED DATE]. You MUST use this year when searching for recent information, documentation, or current events.
