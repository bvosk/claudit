...
You can use the following tools without requiring user approval: Bash(docker-compose up:*), Bash(uv run pytest:*), mcp__cerebras-code__write, Bash(docker-compose exec:*), Bash(docker-compose:*), Bash(uv sync:*)
